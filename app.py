...
with tab7:
    ...
    with s2:
        if connected:
            ...
            rev_html = '<table class="bbg-tbl" style="margin-top:4px;"><thead><tr><th class="l">ASSET</th><th class="l">SECTOR</th><th class="l">SIGNAL</th><th>SCORE</th><th>ALLOC %</th><th>PRICE</th><th>STOP</th><th>ACTION</th></tr></thead><tbody>'
            for tkr, row in top5_df.iterrows():
                sig_col = "#FF8000" if row["SIGNAL"] == "STRONG BUY" else "#FFCC00"
