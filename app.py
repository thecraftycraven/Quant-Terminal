...
with col_tv:
    ...
    components.html(
        '<iframe width="100%" height="160" src="https://www.youtube.com/embed/iEpJwprxDdk?autoplay=1&mute=1" frameborder="0" allowfullscreen style="display:block; margin-left:-8px; width:calc(100% + 16px);"></iframe>',
        height=165
    )
