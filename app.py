...
with tab5:
    ...
    with n2:
        ...
        st.markdown('<div style="color:#555;font-size:9px;margin-bottom:40px;letter-spacing:1px;">TYPE YOUR NOTES BELOW — USE FOR TRADE RATIONALE, OBSERVATIONS, REMINDERS</div>', unsafe_allow_html=True)
        st.text_area(
            label="",
