...
with tab5:
    ...
    with n1:
        ...
        if newsapi_articles:
            news_html='<div class="bbg-panel" style="margin-top:15px;"><table class="bbg-tbl"><thead><tr><th class="l">HEADLINE</th><th class="l">SOURCE</th><th class="l">TIME</th></tr></thead><tbody>'
